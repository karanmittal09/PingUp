import { BadgeCheck, Key, X } from 'lucide-react'
...
const StoryViewer = ({ viewStory, setViewStory }) => {
  ...
  const renderContent = () => {
    switch(viewStory.media_type) {
      ...
      case 'video':
        return(
          <video onEnded={()=>{setViewStory(null)}} controls autoPlay src={viewStory.media_url}  className='max-w-full max-h-screen object-contain'/>
        );
